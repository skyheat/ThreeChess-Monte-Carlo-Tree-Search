...
public enum Position {
  ...
  RA1(Colour.RED, 0, 0), RA2(Colour.RED, 1, 0), RA3(Colour.RED, 2, 0), RA4(Colour.RED, 3, 0), RB1(Colour.RED, 0, 1),
  RB2(Colour.RED, 1, 1), RB3(Colour.RED, 2, 1), RB4(Colour.RED, 3, 1), RC1(Colour.RED, 0, 2), RC2(Colour.RED, 1, 2),
  RC3(Colour.RED, 2, 2), RC4(Colour.RED, 3, 2), RD1(Colour.RED, 0, 3), RD2(Colour.RED, 1, 3), RD3(Colour.RED, 2, 3),
  RD4(Colour.RED, 3, 3), RE1(Colour.RED, 0, 4), RE2(Colour.RED, 1, 4), RE3(Colour.RED, 2, 4), RE4(Colour.RED, 3, 4),
  RF1(Colour.RED, 0, 5), RF2(Colour.RED, 1, 5), RF3(Colour.RED, 2, 5), RF4(Colour.RED, 3, 5), RG1(Colour.RED, 0, 6),
  RG2(Colour.RED, 1, 6), RG3(Colour.RED, 2, 6), RG4(Colour.RED, 3, 6), RH1(Colour.RED, 0, 7), RH2(Colour.RED, 1, 7),
  RH3(Colour.RED, 2, 7), RH4(Colour.RED, 3, 7);
  ...
  /**
   * Gets the neighbouring cell in the given direction. Cells always move forward
   * towards the center line, so the direction is independent of piece colour.
   * 
  ...
  /**
   * returns true if the position has even parity equivalent to a black square on
